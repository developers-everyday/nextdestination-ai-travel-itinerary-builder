...
export default function CreateFromTranscriptPage() {
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="flex items-center justify-center gap-4 mb-10 flex-wrap">
                        {[
                            ...
                            <React.Fragment key={i}>
                                ...
                                {i < 2 && <span className="text-slate-300 font-bold hidden md:inline">→</span>}
                            </React.Fragment>
                        ))}
                    </div>
                    ...
                    <div className="bg-white border-2 border-slate-200 rounded-3xl p-6 mb-6 hover:border-indigo-300 transition-colors focus-within:border-indigo-500 focus-within:shadow-lg focus-within:shadow-indigo-50">
                        ...
                        <textarea
                            ...
                            placeholder={`Paste your travel video transcript here...\n\nExample:\n"Hey guys! So I just landed in Bali and let me tell you, this place is incredible. Day one we checked into the COMO Uma Ubud resort — highly recommend. We spent the morning at the Tirta Empul temple, had lunch at Locavore..."`}
                            rows={12}
