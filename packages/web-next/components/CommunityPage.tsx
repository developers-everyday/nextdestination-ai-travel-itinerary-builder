      ...
      {selectedItinerary && (
        <ItineraryDetailModal
          ...
          onCustomize={(itinerary) => {
            const destination =
              itinerary.destination || itinerary.location || "Unknown";
            const days = itinerary.duration || 3;
            router.push(
              `/planning-suggestions?destination=${encodeURIComponent(destination)}&days=${days}`
            );
          }}
        />
      )}
