  ...
  return (
    <div className="group cursor-pointer">
      <div className="relative aspect-[3/4] overflow-hidden rounded-xl bg-slate-200 mb-3">
        ...
        <button className="absolute top-3 right-3 p-2 rounded-full hover:bg-white/10 transition-colors">
          <svg
            ...
            className="h-6 w-6 text-white/70 hover:text-white drop-shadow-md"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
      ...
      <div className="flex justify-between items-start gap-2">
        <div>
          <h3 className="font-bold text-slate-900 text-[15px] leading-tight group-hover:underline decoration-1 underline-offset-2 decoration-transparent group-hover:decoration-slate-900 transition-all">
            {location}
          </h3>
        ...
        <div className="flex items-center gap-1 text-[15px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-3.5 w-3.5 text-slate-900 fill-slate-900"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
