        ...
        <div className="fixed inset-0 z-[5000] flex items-center justify-center bg-black/50 backdrop-blur-sm">
            ...
            >
                ...
                <div className="mt-8 flex items-center justify-between gap-4">
                    ...
                    <button
                        onClick={handleSave}
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-xs font-bold text-white transition-all shadow-lg bg-blue-600 hover:bg-blue-700 shadow-blue-500/20"
                    >
                        <Save size={14} />
                        Save Changes
                    </button>
