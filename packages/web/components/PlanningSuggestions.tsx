...
const MOCK_COMMUNITY_ITINERARIES: CommunityItinerary[] = [
    ...
    },
    {
        ...
        creator: { id: 'm3', name: 'FoodieFan', avatar: 'https://api.dicebear.com/7.x/initials/svg?seed=Foodie', verified: false },
        saveCount: 2300,
        duration: 3,
        tags: ['Foodie', 'Urban'],
        category: 'Adventure',
                ...
                if (data && data.length > 0) {
                    ...
                    const mapped: CommunityItinerary[] = data.map((item: any) => ({
                        ...
                        creator: {
                            ...
                            avatar: 'https://api.dicebear.com/7.x/initials/svg?seed=' + (item.id || 'Felix'),
                            verified: true
                        },
