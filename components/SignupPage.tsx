        ...
        <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-slate-50">
            ...
            <div className="relative z-10 w-full max-w-md p-10 mx-4 bg-white border border-slate-100/50 rounded-3xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] animate-slide-up">
                <div className="text-center mb-10">
                    ...
                    <h2 className="text-3xl font-black text-slate-900 tracking-tight mb-2 font-display">Create Account</h2>
                ...
                <div className="mt-8 text-center">
                    <p className="text-slate-500 text-sm font-medium">Already have an account? <button onClick={() => navigate('/login')} className="text-indigo-600 font-bold hover:text-indigo-700 transition-colors">Log in</button></p>
                </div>
            </div>
